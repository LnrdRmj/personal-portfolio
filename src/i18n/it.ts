...
const itTranslations: Translations = {
    ...
    headerSection: {
        ...
        contacts: "Contatti",
        menu: {
            catchPhrase: "Prenota una consulenza gratuita per discutere con me del tuo progetto.",
        },
    },
    knoweachotherbutton: "Conosciamoci!",
    technolgiesSection: {
        title: "Tecnologie e linguaggi che conosco",
    },
    featuredWorks: {
