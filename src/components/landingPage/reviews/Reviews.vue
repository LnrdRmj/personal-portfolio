...
<template>
    <div class="flex flex-col bg-secondary rounded-[20px] px-5 sm:px-16">
        ...
        <div class="flex flex-col
            sm:flex-row sm:h-[650px] sm:space-x-5">
            <div class="
                flex flex-wrap
                sm:flex-col sm:flex-nowrap sm:space-y-2">
            ...
            <div class="flex flex-col w-full lg:flex-row">
                ...
                <div class="relative max-h-96 h-96 w-full mt-5
                    sm:h-auto flex sm:flex-1 sm:max-h-none
                    lg:w-[50%]">
