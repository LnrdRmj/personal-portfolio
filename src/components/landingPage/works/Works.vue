...
<template>
    <div class="flex flex-col">
        ...
        <div
            class="w-full [&>*]:items-center [&>*:last-child]:border-b [&>*:last-child]:border-b-black"
        >
            ...
            >
                <div
                    class="hidden sm:block w-2/12 text-zinc-400 group-hover:pl-5 transition-[padding]"
                >
                    {{ work.period }}
                </div>
                <div
                    class="w-[45%] sm:w-2/12 group-hover:pl-5 group-hover:text-white transition-[padding]"
                >
                    {{ work.clientName }}
                </div>
                <div
                    class="w-[45%] sm:w-3/12 group-hover:pl-5 group-hover:text-white transition-[padding]"
                >
                    {{ work.role[i18next.language] }}
                </div>
                <div class="hidden w-3/12 sm:flex space-x-3 text-sm">
                    <div
                        v-for="skill of work.skills"
