    ...
    <div class="flex flex-col">
        ...
        <div class="w-full [&>*]:items-center [&>*:last-child]:border-b [&>*:last-child]:border-b-black">
            ...
            <div v-for="(work, index) of works" @mouseenter="hovered[index] = true" @mouseleave="hovered[index] = false"
                ...
                <div class="w-2/12">
                    <button class="transition-all group-hover:border group-hover:border-white group-hover:text-white sm:px-3 sm:py-[1px] rounded-full
                        sm:bg-transparent sm:size-auto
                        bg-black size-7">
