<script setup lang="ts">
    ...
    function loopFirstChildCallback(
        thresholds: IntersectionObserverEntry[],
        ...
        slider.value!.scrollLeft -=
            slider.value!.children[0].clientWidth + parseInt(style.marginLeft);
        nextTick(() => {
            fullyHiddenObserver.observe(slider.value!.children[0]);
        });
    }
...
<template>
    <div class="bg-secondary px-10 py-20">
        ...
        <div
            class="flex overflow-x-scroll hide-scrollbar"
            ref="slider"
        ...
        >
            ...
            <div
                class="flex-center flex-col ml-4 h-64 w-64 shrink-0"
