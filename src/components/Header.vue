...
<template>
    <div class="flex flex-col relative">
        <div
            class="bg-black flex justify-between items-center text-white text-xl py-5 px-10 relative z-20"
        >
            <div>Leonardo Ramaj</div>
        ...
        <div
            class="lg:hidden text-white bg-black absolute top-full left-0 flex flex-col md:flex-row w-full h-screen md:h-fit z-10 py-12 px-8 transition-[opacity,transform] duration-[250ms]"
        ...
        >
            ...
            <div
                class="bg-gray-500 h-[1px] w-full md:h-auto md:w-[1px] mt-16 mb-10 md:mt-0 md:mb-0"
            ></div>
